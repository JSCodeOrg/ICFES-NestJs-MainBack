...
async function bootstrap() {
  ...
  const config = new DocumentBuilder().setTitle('ICFES BI-Dashboard Backend').setDescription('ICFES BI-Dashboard main backend').setVersion('1.0').addBearerAuth().build();
